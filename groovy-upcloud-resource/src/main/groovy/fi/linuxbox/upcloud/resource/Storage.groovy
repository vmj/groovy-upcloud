...
class Storage extends Resource {
     ...
     * <p>
     *     This is available in the storage list and details responses.  This can not be specified when creating a
     *     storage, since all user created storages are private.
     * </p>
     ...
     * Storage backup rule.
     * <p>
     *     This is available in the storage details response.  This can optionally be specified when creating a
     *     storage, where this defaults to {@code null} (no backup rule).
     * </p>
     */
     ...
     * <p>
     *     This is available in the storage details response.  This can not be specified when creating a storage.
     * </p>
     */
    List<String> backups
    /**
     ...
     *     creating a storage, where this defaults to {@code hdd}.
     * </p>
