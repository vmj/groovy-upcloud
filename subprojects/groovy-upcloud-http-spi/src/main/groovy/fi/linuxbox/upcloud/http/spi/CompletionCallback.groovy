...
interface CompletionCallback {
     ...
     *     second argument, the <code>entity</code>, can be <code>null</code> if the HTTP response
     ...
     */
    void completed(final META meta, final byte[] entity, final Throwable error) throws InterruptedException
}
