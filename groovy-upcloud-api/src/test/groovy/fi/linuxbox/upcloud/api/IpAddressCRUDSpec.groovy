...
class IpAddressCRUDSpec extends ApiSpecification {
    ...
    // build minimal class that works for the IpAddress trait: HTTP and address
    def ipAddress = build 'IpAddress', HTTP: session, { address = '0.0.0.0' } withTraits IpAddress
